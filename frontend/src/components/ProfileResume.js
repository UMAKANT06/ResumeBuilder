...
const ProfileResume = ({ values }) => {
  ...
  * {
  ...
  // You can now use the 'staticResumeHTML' string as needed, for example, to inject it into a document or render it on a web page.
  console.log(htmlTemplate); // Log to console for demonstration
